...
public class List {
    ...
    public List List_doble_solicitud(List l)
    {
        Estudiante aux_e = new Estudiante();
        List li = new List();
        Node aux = first;
        ...
        while(aux!= null)
        {
            id = ((Estudiante) aux.getData()).getIdentificacion();
            
            aux_e = l.Search(id);
            
            if(aux_e.getIdentificacion()==id){
                li.AddLast(aux_e);
            }
    ...
    public Estudiante Search(int id)
    {
        Estudiante e = new Estudiante();
        Node aux = first;
        while(aux!= null)
        {
            if(((Estudiante)aux.getData()).getIdentificacion()==(id))
                e=(Estudiante)aux.getData();
